...
class DetallePage extends StatelessWidget {
  ...
  DetallePage(this.producto, this.description, this.pathImagen, this.precio) {
    print(this.precio);
    print(this.producto);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Detalle(
          this.producto, this.description, this.pathImagen, this.precio),
    );
  }
}
...
class Detalle extends StatelessWidget {
  ...
  Detalle(this.producto, this.description, this.pathImagen, this.precio) {
